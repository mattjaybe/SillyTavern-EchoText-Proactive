...
- No new settings to learn — SillyTavern detects the plugin automatically and switches to server-backed scheduling for EchoText
...
### Step 4 (Optional) — Confirm it's working
